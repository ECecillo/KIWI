...
function MusicInfos(props){
    ...
    return(
        <div className="scrollbar-hide overflow-y-auto overflow-x-hidden h-3/5"> {/*  modif: h-3/5  ====> h-2/5 || edit: reverse car template tendance utilisé pour afficher les playlists */}
            ...
            <div id={elmt.track.id} className="music-infos grid grid-cols-5 items-center rounded-lg font-sans text-lg select-none px-5 bg-transparent h-14  dark:hover:bg-neutral-700 hover:bg-gray-200 dark:text-neutral-400" key={`${elmt}-${index}`}>
