...
function RightSection() {
    return (
        <div className="rightSection basis-2/12 h-screen relative mr-6 py-6 hidden lg:block">
            <p className='font-sans text-2xl font-semibold mb-5 dark:text-white'>Shortcuts</p>
            ...
            <div className="infos-music-playing absolute inset-x-0 bottom-0 p-6 mb-6 flex flex-col items-center gap-2 rounded-3xl bg-white dark:bg-dark-soft-black drop-shadow-2xl">
                ...
                <div className='infos-music w-full'>
                    <span>
                        <p id='music-title' className='font-sans text-lg font-semibold dark:text-white'>Till It's Gone</p>
                        <p id='music-artist' className='font-sans text-neutral-500 dark:text-neutral-200'>Yelawolf</p>
                    </span>
                </div>
            </div>
        </div>
