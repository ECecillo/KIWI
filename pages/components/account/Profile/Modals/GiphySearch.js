...
export function Components({ onClose }) {
    ...
    return (
        <>
            <SearchBar className='mb-5 rounded-md mt-4' />
            <SuggestionBar />
            <div className='max-h-80 overflow-y-auto overflow-x-hidden'>
                <Grid key={searchKey} gutter={10} columns={2} width={550} fetchGifs={fetchGifs} noLink={true} borderRadius={6} onGifClick={(gif, event) => {
