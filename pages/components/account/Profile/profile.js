	...
	return (
		< div className='flex flex-row items-center w-fit' >
			...
			>
				...
				<img className='rounded-full object-cover h-20 w-20 max-h-15 max-w-sm mr-4 shadow-md shadow-[#42678b]'
					src={newImage !== "" ? newImage : image_profile} // Affiche la nouvelle image si on en a mis une, sinon on affiche l'ancienne.
					alt='Image profile' />
			</button>
			<h1 className='font-bold text-2xl dark:text-dark-white'>{userName}</h1>
