...
function Card({ name, image, droits, account_id }) {
    ...
    return (
        <div className={`grid grid-rows-[0.4fr_0.1fr_0.1fr] mx-2 gap-4 rounded-3xl border-2 ${brandBorder} dark:bg-transparent`}>
            {/* Image Google */}
            ...
            <section aria-labelledby='access-token' className='flex flex-col flex-none dark:text-dark-white text-dark-black'>
                <h2 id="access-token" className='text-center mb-3'>ID Compte</h2>
            ...
            <button className='transition ease-in-out duration-400 dark:bg-dark-soft-black rounded-full mx-auto my-2 p-1 border-2 dark:border-white hover:dark:bg-red-600'>
