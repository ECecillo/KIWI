...
async function createSongs(songs) {
    ...
    try {
        ...
        if (result > 0)
            console.debug("Transaction Réussi ", result);
 ...
 */
export async function getSongsData(data, song_data, playlist_data, songIds, playlistsId) {
    data.map((song) => {
