...
export async function refreshAccessTokenSpotify(token) {
  try {
    ...
    console.log("SpotifyAPI Types : ", spotifyApi._credentials.clientID);
    console.log("SpotifyApi ClientID : ", spotifyApi.getClientId());
    ...
    // token_expiration_time = Nouveau temps.
    return {
